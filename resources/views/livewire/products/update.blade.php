<div>
    <form wire:submit.prevent="edit">
        ...
        <div class="row">
            <div class="col-md-12">
                <button type="button" class="btn btn-primary btn-sm" wire:click.prevent="update">Update</button>
                <button type="button" wire:click.prevent="cancel" class="btn btn-dark btn-sm">Cancel</button>
            </div>
        </div>
